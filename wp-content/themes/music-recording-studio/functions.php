...
function music_recording_studio_scripts() {
	...
	wp_enqueue_script( 'music-recording-studio-custom-scripts-jquery', esc_url(get_template_directory_uri()) . '/assets/js/custom.js', array('jquery'),'' ,true );
	wp_enqueue_script( 'music-recording-studio-wow-jquery', esc_url(get_template_directory_uri()) . '/assets/js/wow.js', array('jquery'),'' ,true );
...
define('MUSIC_RECORDING_STUDIO_FREE_THEME_DOC',__('https://www.vwthemesdemo.com/docs/free-music-recording-studio/','music-recording-studio'));
...
function music_recording_studio_tagline_hide_show(){
	if(get_theme_mod('music_recording_studio_tagline_hide_show') == '1' ) {
		return true;
	}
	return false;
}
