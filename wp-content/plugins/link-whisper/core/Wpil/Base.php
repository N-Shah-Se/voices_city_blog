...
class Wpil_Base
{
    ...
    public static function addScripts($hook)
    {
        ...
        wp_register_script('wpil_admin_settings_script', WP_INTERNAL_LINKING_PLUGIN_URL.$js_path, array('jquery'), $ver, true);
        ...
        if (!empty($current_screen) && ('post' === $current_screen->base || 'page' === $current_screen->base)){
            ...
            wp_register_script('wpil_select2', WP_INTERNAL_LINKING_PLUGIN_URL . 'js/select2.min.js', array('jquery'), $ver, true);
	...
	public static function columns_contents($column_name, $post_id){
        if('wpil-link-stats' === $column_name){
            ...
            $post_scanned = !empty(get_post_meta($post_id, 'wpil_sync_report2_time', true));
    ...
    public static function delete_link_whisper_data(){
        ...
        $settings = array(
            ...
            'wpil_email_offer_dismissed',
            'wpil_signed_up_email_offer',
            'wpil_premium_notice_dismissed',
        );
